...
const Main = ({ photoURL, displayName, id_name }) => {
    ...
    return (
        <div className="w-[60vw] 2xl:w-[82vw] xl:w-[90vw] lg:w-[92.5vw] h-[96h] bg-[#f0f2f5] text-[#222] px-8 lg:px-0 flex flex-col items-center no-scrollbar .no-scrollbar::-webkit-scrollbar overflow-y overflow-x-hidden overflow-scroll">
